...
### Step 5. 在 Cloudflare 中部署 Pages 应用程序
...
### Step 6. 绑定 KV 数据库与环境变量
1. 部署完成后，进入该 Pages 项目的后台，点击 **设置** -> **函数 (Functions)**。
2. 找到 **KV 命名空间绑定** 区域，点击 **添加绑定**。
...
1. **注册免费域名**（任选其一访问）：
   * [免费域名渠道 A](https://my.dnshe.com/index.php?m=domain_hub&view=tools&invite_code=UUP5ZVLXJ4CH)
   * [免费域名渠道 B](https://my.dnshe.com/index.php?m=domain_hub&view=tools&invite_code=NZLV55V7ZAHF)
